    ...
    for tag in soup.find_all(style=True):
        ...
        if "contact-img" in classes:
            if "odessa-tx-06" in st:
                tag["style"] = "background-image:url('/ours/locations/commercial-roofers-odessa-tx-06.webp')"
            elif "odessa-tx-07" in st:
                tag["style"] = "background-image:url('/ours/locations/commercial-roofers-odessa-tx-07.webp')"
